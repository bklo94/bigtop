file(REMOVE_RECURSE "/src/cmake-3.12.3/Tests/CMakeTests/uploads")

if(EXISTS "/src/cmake-3.12.3/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/src/cmake-3.12.3/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/src/cmake-3.12.3/Tests/CMakeTests/uploads")

set(filename "/src/cmake-3.12.3/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/src/cmake-3.12.3/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/src/cmake-3.12.3/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/src/cmake-3.12.3/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/src/cmake-3.12.3/Tests/CMakeTests/uploads/file2.png"
